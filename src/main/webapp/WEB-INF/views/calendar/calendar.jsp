...
<div id="teamCalContainer">
	...
	<div id="sidebar">
	 ...
	 <div id="teamCalContent">		
				
		<!-- 달력 -->		
		<div class="mt-3 mb-3 p-3 d-flex justify-content-between">
			<span>
				<a class="btn btn-outline-dark btn-sm" href="calendar.do?tNo=<%=tNo%>&year=<%=year%>&month=<%=month-1%>">[이전달]</a>
			</span> 
			<span class="fw-bold fs-3"><%=year%>년 <%=month+1%>월</span> 
			<span>
				<a class="btn btn-outline-dark btn-sm"href="calendar.do?tNo=<%=tNo%>&year=<%=year%>&month=<%=month+1%>"> [다음달] </a>
			</span>
		</div>
		...
		<table class="table text-left table-bordered" style="width:100%;">
			<tr class="table-light text-center fs-3 tr-h" style="cursor:default;">
