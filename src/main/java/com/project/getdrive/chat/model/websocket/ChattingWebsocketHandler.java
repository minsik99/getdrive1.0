package com.project.getdrive.chat.model.websocket;
...
import com.project.getdrive.chatcontent.model.service.ChatContentService;
...
public class ChattingWebsocketHandler extends TextWebSocketHandler{
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        ChatContent msg = objectMapper.readValue( message.getPayload(), ChatContent.class);
        
        // Message 객체 확인
        System.out.println(msg); 
        
        // DB 삽입 서비스 호출
        int result = ChatContentService.insertMessage(msg);
        ...
        if(result > 0 ) {
            ...
            for(WebSocketSession s : sessions) {
                ...
                int loginMemberNo = ((ChatUser)s.getAttributes().get("loginMember")).getMemberNo();
