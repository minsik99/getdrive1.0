...
CREATE TABLE "TB_CALENDER" 
   ...
   "CL_UDATE" DATE, 
   "CL_CHECK" CHAR(1 BYTE) NOT NULL ENABLE, 
   "CL_CRUID" NUMBER NOT NULL ENABLE, 
   "CL_XPOINT" FLOAT(126), 
   "CL_YPOINT" FLOAT(126), 
   "CL_TID" NUMBER NOT NULL ENABLE, 
    CONSTRAINT "TB_CALENDER_PK" PRIMARY KEY ("CL_NO", "CL_TID") , 
    CONSTRAINT "TB_CALENDER_FK1" FOREIGN KEY ("CL_TID")
     REFERENCES "TB_TEAM" ("T_NO") ENABLE, 
    CONSTRAINT "TB_CALENDER_FK2" FOREIGN KEY ("CL_TID", "CL_CRUID")
     REFERENCES "TB_TEAM_USER" ("TU_TID", "TU_MID") ENABLE
);
